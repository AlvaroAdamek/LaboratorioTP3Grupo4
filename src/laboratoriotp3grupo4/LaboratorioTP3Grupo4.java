...
public class LaboratorioTP3Grupo4 {
    ...
    public static void main(String[] args) {
        ...
        guiaTelf.agregarCliente(cliente1, tel1);
        guiaTelf.agregarCliente(cliente2, tel2);
        guiaTelf.agregarCliente(cliente3, tel3);
        ArrayList<Long> telefono= guiaTelf.buscarTelefono("Cooper");
        for (Long long1 : telefono) {
            System.out.println(long1);
        }
       
        
        for (Cliente ari : (guiaTelf.buscarClientes("Fraga"))) {
